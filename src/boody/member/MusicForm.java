...
public class MusicForm extends JFrame implements ActionListener{
   ...
   public MusicForm() {
      ...
      playlist.add(new MusicVO("1", "누구야1", "C:\\koreaIT\\javaworkspace\\boody\\res\\music\\Brave Girls-Rollin.mp3"));
      playlist.add(new MusicVO("2", "누구야2", "C:\\koreaIT\\javaworkspace\\boody\\res\\music\\BTS-Dynamite.mp3"));
      playlist.add(new MusicVO("3", "누구야3", "C:\\koreaIT\\javaworkspace\\boody\\res\\music\\SimpleSound.mp3"));
